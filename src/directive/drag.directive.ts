...
export class DragDirective implements OnInit {
  ...
  @HostListener('mousedown', ['$event']) onMousedown(event) {
    ...
    console.log("mousedown:"+this.el.nativeElement.className + "; totalOffsetX:"+ this.totalOffsetX);
  }
  ...
  @HostListener('document:mouseup', ['$event']) onMouseup(event) {
    ...
    //   console.log('fail');
      ...
      this.isDown = false;
      console.log("mouseup:"+this.el.nativeElement.className + "; totalOffsetX:"+ this.totalOffsetX);
    }
  }
